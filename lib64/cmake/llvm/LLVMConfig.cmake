...
set(LLVM_DEFAULT_EXTERNAL_LIT "/home/runner/build-clang/build/./bin/llvm-lit")
set(LLVM_HAVE_OPT_VIEWER_MODULES 0)
set(LLVM_CONFIGURATION_TYPES )
set(LLVM_ENABLE_SHARED_LIBS OFF)

if(NOT TARGET LLVMSupport)
  set(LLVM_EXPORTED_TARGETS "LLVMDemangle;LLVMSupport;LLVMTableGen;llvm-tblgen;LLVMCore;LLVMFuzzMutate;LLVMIRReader;LLVMCodeGen;LLVMSelectionDAG;LLVMAsmPrinter;LLVMMIRParser;LLVMGlobalISel;LLVMBinaryFormat;LLVMBitReader;LLVMBitWriter;LLVMBitstreamReader;LLVMDWARFLinker;LLVMExtensions;LLVMFrontendOpenMP;LLVMTransformUtils;LLVMInstrumentation;LLVMAggressiveInstCombine;LLVMInstCombine;LLVMScalarOpts;LLVMipo;LLVMVectorize;LLVMObjCARCOpts;LLVMCoroutines;LLVMCFGuard;LLVMLinker;LLVMAnalysis;LLVMLTO;LLVMMC;LLVMMCParser;LLVMMCDisassembler;LLVMMCA;LLVMObject;LLVMObjectYAML;LLVMOption;LLVMRemarks;LLVMDebugInfoDWARF;LLVMDebugInfoGSYM;LLVMDebugInfoMSF;LLVMDebugInfoCodeView;LLVMDebugInfoPDB;LLVMSymbolize;LLVMExecutionEngine;LLVMInterpreter;LLVMJITLink;LLVMMCJIT;LLVMOrcError;LLVMOrcJIT;LLVMRuntimeDyld;LLVMTarget;LLVMX86CodeGen;LLVMX86AsmParser;LLVMX86Disassembler;LLVMX86Desc;LLVMX86Info;LLVMARMCodeGen;LLVMARMAsmParser;LLVMARMDisassembler;LLVMARMDesc;LLVMARMInfo;LLVMARMUtils;LLVMAArch64CodeGen;LLVMAArch64AsmParser;LLVMAArch64Disassembler;LLVMAArch64Desc;LLVMAArch64Info;LLVMAArch64Utils;LLVMAsmParser;LLVMLineEditor;LLVMProfileData;LLVMCoverage;LLVMPasses;LLVMTextAPI;LLVMDlltoolDriver;LLVMLibDriver;LLVMXRay;LLVMWindowsManifest;LTO;LLVMgold;llvm-ar;llvm-config;llvm-lto;llvm-profdata;clang-tblgen;yaml2obj;verify-uselistorder;sanstats;sancov;Remarks;opt;obj2yaml;llvm-xray;llvm-undname;llvm-symbolizer;llvm-strings;llvm-stress;llvm-split;llvm-size;llvm-rtdyld;llvm-reduce;llvm-readobj;llvm-rc;llvm-pdbutil;llvm-opt-report;llvm-objdump;llvm-objcopy;llvm-nm;llvm-mt;llvm-modextract;llvm-ml;llvm-mca;llvm-mc;llvm-lto2;llvm-lipo;llvm-link;llvm-jitlink;llvm-ifs;llvm-gsymutil;llvm-extract;llvm-exegesis;llvm-elfabi;llvm-dwp;llvm-dwarfdump;llvm-dis;llvm-diff;llvm-cxxmap;llvm-cxxfilt;llvm-cxxdump;llvm-cvtres;llvm-cov;llvm-cfi-verify;llvm-cat;llvm-c-test;llvm-bcanalyzer;llvm-as;lli;llc;dsymutil;bugpoint;PollyISL;PollyPPCG;Polly;LLVMPolly")
